...
router.post("/register", async (req, res) => {
    try {
        ...
        const token = CreateToken({ id: customer._id, username: customer.username, email: customer.email, role: customer.role }, "1h")
...
router.post("/login", async (req, res) => {
    try {
        ...
        // create token
        const token = CreateToken({ id: customer._id, username: customer.username, email: customer.email, role: customer.role })
